...
import { carOutline as carIcon, closeOutline as closeIcon } from 'ionicons/icons';
...
@inject('userStore')
@observer
export default class AddCarModal extends React.Component<AddCarModalProps, AddCarModalState> {
    private visible(): boolean {
        return this.props.uiStore?.modals.addCarModal;
    }

    public state: AddCarModalState = {
        type: '',
        brand: '',
        model: '',
        variant: '',
                            ...
                            <IonRow>
                                <IonCol>
                                    <IonItem className="c-item-ic">
                                        ...
                                        <IonInput onIonChange={(event): void => this.handleInput(event.detail.value, 'brand')}>
